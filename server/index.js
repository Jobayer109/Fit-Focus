...
async function run() {
  try {
    ...
    const RequestToBeTainerDB = client
      .db("Fitness-Tracker-Project")
      .collection("RequestToBeTainer");
    const NewsLatterDB = client
      .db("Fitness-Tracker-Project")
      .collection("NewsLatter");
    const NewClassDB = client
      .db("Fitness-Tracker-Project")
      .collection("classes");
    const PaymentDB = client
      .db("Fitness-Tracker-Project")
      .collection("paymentHistory");
    const forumPosttDB = client
      .db("Fitness-Tracker-Project")
